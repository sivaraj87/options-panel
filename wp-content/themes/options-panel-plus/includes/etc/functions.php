...
jQuery(document).ready(function() {
	...
	jQuery('#advanced1_showhidden').click(function() {
  		jQuery('#section-advanced1_text_hidden').fadeToggle(400);
	});
	
	if (jQuery('#advanced1_showhidden:checked').val() !== undefined) {
		jQuery('#section-advanced1_text_hidden').show();
	}
	
        //block 1 checkbox toggle
	jQuery('#advanced2_showhidden').click(function() {
  		jQuery('#section-advanced2_text_hidden').fadeToggle(400);
	});
	
	if (jQuery('#advanced2_showhidden:checked').val() !== undefined) {
		jQuery('#section-advanced2_text_hidden').show();
	}
